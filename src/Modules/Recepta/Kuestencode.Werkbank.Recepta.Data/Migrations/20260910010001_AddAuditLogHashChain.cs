    ...
    public partial class AddAuditLogHashChain : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE recepta.""AuditLogEntries""
            ...
            migrationBuilder.Sql(@"
                ...
                ON recepta.""AuditLogEntries"" (""SequenceNumber"");
            ");
            ...
            migrationBuilder.Sql(@"
                CREATE OR REPLACE FUNCTION recepta.audit_log_entries_append_only() RETURNS trigger AS $$
                BEGIN
                    RAISE EXCEPTION 'recepta.AuditLogEntries ist append-only (GoBD) - UPDATE/DELETE nicht erlaubt.';
                END;
                $$ LANGUAGE plpgsql;
            ");

            migrationBuilder.Sql(@"
                DROP TRIGGER IF EXISTS trg_audit_log_entries_append_only ON recepta.""AuditLogEntries"";
            ");

            migrationBuilder.Sql(@"
                CREATE TRIGGER trg_audit_log_entries_append_only
                BEFORE UPDATE OR DELETE ON recepta.""AuditLogEntries""
                FOR EACH ROW EXECUTE FUNCTION recepta.audit_log_entries_append_only();
            ");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                DROP FUNCTION IF EXISTS recepta.audit_log_entries_append_only();
            ");

            migrationBuilder.Sql(@"
                DROP INDEX IF EXISTS recepta.""IX_AuditLogEntries_SequenceNumber"";
            ");
