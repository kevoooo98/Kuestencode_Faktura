    ...
    public partial class AddAuditLogEntries : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                CREATE TABLE IF NOT EXISTS recepta.""AuditLogEntries"" (
                    ""Id"" uuid NOT NULL,
                ...
                CREATE INDEX IF NOT EXISTS ""IX_AuditLogEntries_EntityName_EntityId"" ON recepta.""AuditLogEntries""(""EntityName"", ""EntityId"");
            ");
        }
        ...
        {
            migrationBuilder.Sql(@"
                DROP TABLE IF EXISTS recepta.""AuditLogEntries"";
            ");
        }
    }
}
