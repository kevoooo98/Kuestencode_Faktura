...
- Anpassbare PDF- und E-Mail-Layouts
...
- keine Cloud-Software
- kein Abo-Modell

## Installation (empfohlen)

Küstencode Faktura wird als Docker-Compose-Stack betrieben
(z. B. auf einem NAS oder Server im eigenen Netzwerk).
